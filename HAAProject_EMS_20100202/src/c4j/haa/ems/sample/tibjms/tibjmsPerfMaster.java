 ...
 * 
 * $Id: tibjmsPerfMaster.java 23346 2006-10-13 17:46:43Z $
 * 
 */
...
public class tibjmsPerfMaster
{
    ...
    private void printPerformance() throws JMSException
    {
        ...
        while (numReceivers-- > 0)
        {
            System.err.println("Waiting for performance results from " + (numReceivers + 1) + " slave program(s)");
