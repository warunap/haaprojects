		...
		if (!articleList || articleList.length == 0) {
			...
			$(articleList).each(function () {
				...
				a.click(function () {
					...
					var btn = $("<input type='button'/>").val("\u539f\u6587");
					var buttonBtn= btn.clone();
					var openframefunc=function () {
						btn.remove();
						buttonBtn.remove();
