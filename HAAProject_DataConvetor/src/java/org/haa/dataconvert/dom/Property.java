...
import org.haa.dataconvert.util.BuildUtil;
...
public class Property implements Serializable {
	...
	public Object parse(String value, int lineNo) throws org.haa.dataconvert.exception.ParseException {
		...
		if (TYPE_STRING.equals(type))
			...
			try {
				...
				throw new org.haa.dataconvert.exception.ParseException(e);
			}
		}
		return value;
	}
	...
	public void validate(String val, int lineNo) throws org.haa.dataconvert.exception.ParseException {
		if (StringUtils.isNotBlank(pattern) && !val.matches(pattern)) {
			...
			throw new org.haa.dataconvert.exception.ParseException(sb.toString());
		}
	}
