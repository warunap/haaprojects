 ...
 * 
 * $Id: tibjmsSelector.java 21731 2006-05-01 21:41:34Z $
 * 
 */
...
public class tibjmsSelector
{
    ...
    public tibjmsSelector(String[] args) {
        ...
        try
        {
            ...
            QueueSession receive_session = connection.createQueueSession(false,javax.jms.Session.AUTO_ACKNOWLEDGE);
            QueueSession send_session = connection.createQueueSession(false,javax.jms.Session.AUTO_ACKNOWLEDGE);
             ...
             * drain the queue
             */
            QueueReceiver receiver = receive_session.createReceiver(queue);
            ...
            for (int i=0; i<receiver_count; i++) {
                ...
                receiver = receive_session.createReceiver(queue,selector);
             ...
             * create sender
             */
            QueueSender sender = send_session.createSender(queue);
