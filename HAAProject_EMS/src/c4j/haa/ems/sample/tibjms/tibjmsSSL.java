 ...
 * 
 * $Id: tibjmsSSL.java 21731 2006-05-01 21:41:34Z $
 * 
 */
...
public class tibjmsSSL
{
    ...
    public tibjmsSSL(String[] args) {
        ...
        try {
            ...
            //
            com.tibco.tibjms.TibjmsSSL.setSecureRandom(tibjmsUtilities.createUnsecureRandom());
        }
        catch(Exception e) {
            e.printStackTrace();
        ...
        try
        {
            ...
            TopicConnectionFactory factory = new com.tibco.tibjms.TibjmsTopicConnectionFactory(serverUrl,null,environment);
